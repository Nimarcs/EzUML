...
public class AffichageErreur {
    ...
    public synchronized static void instancier(JFrame jFrame) {
        ...
        if (jFrame == null) throw new NullPointerException("La JFrame doit etre non null et correspondre a votre fenetre principale");
    ...
    public synchronized static AffichageErreur getInstance() {
        if (affichageErreur == null) throw new IllegalStateException("Vous devez instancier l'affichage de l'erreur prealablement");
